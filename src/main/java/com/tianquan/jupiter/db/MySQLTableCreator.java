...
public class MySQLTableCreator {
    ...
    // DONT RUN THIS IF THERE IS EXISTING DATABASE!!!!!
...
//    );
    ...
    public static void main(String[] args) {
        try {
            ...
            // workaround for some corner cases
            ...
            // delete facorite first because of foreign key
            ...
            sql = "INSERT INTO users VALUES('1111', '3229c1097c00d497a0fd282d586be050', 'Mike', 'Jon')";
            statement.executeUpdate(sql);
