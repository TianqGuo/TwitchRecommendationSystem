...
class App extends React.Component {
  ...
  favoriteOnChange = () => {
    // this data is the response in utils.js
    ...
    <Layout>
      <Header>
        <Row justify="space-between">
            ...
            <Col>
              {/* check if logged in or not, if logged in, shows Logout, if not logged in, shows Login and Register buttons */}
              {
                this.state.loggedIn ? 
                <Button shape="round" onClick={this.signoutOnClick} style={{ marginRight: '20px' }}>
                  Logout</Button>
                 :
                (
                  <>
              ...
              {
                this.state.loggedIn ?
                <Button shape="square" type="Secondary">
                  Welcome Back</Button> :
                <Button shape="square" type="Secondary">
                  Welcome, Please Login or Register</Button>
              }
            </Col>
          </Row>
      </Header>
